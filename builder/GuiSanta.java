...
public class GuiSanta extends GuiContainer
{
	...
	public GuiSanta(ContainerModMerchant container)
	{
		super(container);
	...
	{
		this.fontRenderer.drawString(StatCollector.translateToLocal("Santa"), 56, 6, 4210752);
	...
	protected void actionPerformed(GuiButton var1)
	{
		...
		if (var2)
		{
			((ContainerModMerchant)this.inventorySlots).setCurrentRecipeIndex(this.currentRecipeIndex);
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
	{
		...
		mc.getTextureManager().bindTexture(new ResourceLocation("textures/gui/container/villager.png"));
	...
	public void drawScreen(int var1, int var2, float var3)
	{
		...
		if (var4 != null && !var4.isEmpty())
		{
			...
			{
				GL11.glBindTexture(GL11.GL_TEXTURE_2D, mc.renderEngine.getTexture(new ResourceLocation("textures/gui/container/villager.png")).getGlTextureId());
				GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
