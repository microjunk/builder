...
public class BuildContainer extends Container
{
    ...
    public BuildContainer(InventoryPlayer inventoryplayer, World world, int i, int j, int k)
    {
        ...
        posY = j;
        posZ = k;
        this.addSlotToContainer(new SlotCrafting(inventoryplayer.player, craftMatrix, craftResult, 0, 133, 40));
        for(int l = 0; l < 5; l++)
        {
    ...
    {
        craftResult.setInventorySlotContents(0, BuilderCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
    }
