...
public class WorldGenSwamp extends StructureGeneratorBase
{
	...
	public WorldGenSwamp(Entity entity, int[][][][] blocks)
	{
		super(entity, blocks);
	}

	public WorldGenSwamp(Entity entity, int[][][][] blocks, int structureFacing) 
	{
		super(entity, blocks, structureFacing);
	}

	public WorldGenSwamp(Entity entity, int[][][][] blocks, int structureFacing, int offX, int offY, int offZ) 
	{
	...
	*/
	...
	public int getRealBlockID(int fakeID, int customData1) 
	{
		...
		switch(fakeID) 
		{
		case SwampBlackSmith.CUSTOM_CHEST1:
			return Block.chest.blockID;
		case SwampBlackSmith.SPAWN_VILLAGER:
	...
	*/
	...
	public void onCustomBlockAdded(World world, int x, int y, int z, int fakeID, int customData1, int customData2)
	{
		...
		case SwampBlackSmith.SPAWN_VILLAGER:
			...
			//((EntityHorse) X).func_110205_ce(1026);
			//((EntityHorse) X).setHorseType(1026);
