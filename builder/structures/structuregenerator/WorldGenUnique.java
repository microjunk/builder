...
public class WorldGenUnique extends StructureGeneratorBase
{
	...
	public WorldGenUnique(Entity entity, int[][][][] blocks)
	{
		super(entity, blocks);
	}

	public WorldGenUnique(Entity entity, int[][][][] blocks, int structureFacing) 
	{
		super(entity, blocks, structureFacing);
	}

	public WorldGenUnique(Entity entity, int[][][][] blocks, int structureFacing, int offX, int offY, int offZ) 
	{
		super(entity, blocks, structureFacing, offX, offY, offZ);
	}

	public WorldGenUnique() 
	{
		super();
	}
	...
	*/
	...
	public int getRealBlockID(int fakeID, int customData1) 
	{
		...
		switch(fakeID) 
		{
		case DesertCastle1.CUSTOM_CHEST1:
