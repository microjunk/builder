...
public class WorldGenOldWest extends StructureGeneratorBase
{
	...
	public WorldGenOldWest(Entity entity, int[][][][] blocks)
	{
		super(entity, blocks);
	}

	public WorldGenOldWest(Entity entity, int[][][][] blocks, int structureFacing) 
	{
		super(entity, blocks, structureFacing);
	}

	public WorldGenOldWest(Entity entity, int[][][][] blocks, int structureFacing, int offX, int offY, int offZ) 
	{
		super(entity, blocks, structureFacing, offX, offY, offZ);
	}

	public WorldGenOldWest() 
	{
		super();
	}
	...
	*/
	...
	public void onCustomBlockAdded(World world, int x, int y, int z, int fakeID, int customData1, int customData2)
	{
		...
		case OldWestStable.SPAWN_HORSE1:
			...
			//Entity X = new EntityHorse(world);
			//((EntityHorse) horse).func_110235_q(2);
