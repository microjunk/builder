...
public class WorldGenRoman extends StructureGeneratorBase
{
	...
	public WorldGenRoman(Entity entity, int[][][][] blocks)
	{
		super(entity, blocks);
	}

	public WorldGenRoman(Entity entity, int[][][][] blocks, int structureFacing) 
	{
		super(entity, blocks, structureFacing);
	}

	public WorldGenRoman(Entity entity, int[][][][] blocks, int structureFacing, int offX, int offY, int offZ) 
	{
		super(entity, blocks, structureFacing, offX, offY, offZ);
	}

	public WorldGenRoman() 
	{
		super();
	}
	...
	*/
	...
	public int getRealBlockID(int fakeID, int customData1) 
	{
		...
		switch(fakeID) 
		{
		case RomanBlkSmth.CUSTOM_CHEST1:
			return Block.chest.blockID;
		case RomanBlkSmth.SPAWN_VILLAGER:
