...
public class WorldGenMedieval extends StructureGeneratorBase
{
	...
	public WorldGenMedieval(Entity entity, int[][][][] blocks)
	{
		super(entity, blocks);
	}

	public WorldGenMedieval(Entity entity, int[][][][] blocks, int structureFacing) 
	{
		super(entity, blocks, structureFacing);
	}

	public WorldGenMedieval(Entity entity, int[][][][] blocks, int structureFacing, int offX, int offY, int offZ) 
	{
		super(entity, blocks, structureFacing, offX, offY, offZ);
	}

	public WorldGenMedieval() 
	{
		super();
	}
	...
	*/
	...
	public int getRealBlockID(int fakeID, int customData1) 
	{
		...
		switch(fakeID) 
		{
		case Forge.CUSTOM_CHEST1:
			return Block.chest.blockID;
		case Forge.SPAWN_VILLAGER:
