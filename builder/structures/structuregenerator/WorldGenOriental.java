...
public class WorldGenOriental extends StructureGeneratorBase
{
	...
	public WorldGenOriental(Entity entity, int[][][][] blocks)
	{
		super(entity, blocks);
	}

	public WorldGenOriental(Entity entity, int[][][][] blocks, int structureFacing) 
	{
		super(entity, blocks, structureFacing);
	}

	public WorldGenOriental(Entity entity, int[][][][] blocks, int structureFacing, int offX, int offY, int offZ) 
	{
		super(entity, blocks, structureFacing, offX, offY, offZ);
	}

	public WorldGenOriental() 
	{
		super();
	}
	...
	*/
	...
	public int getRealBlockID(int fakeID, int customData1) 
	{
		...
		switch(fakeID) 
		{
			case JapanLargeShop1.CUSTOM_CHEST1:
			return Block.chest.blockID;
			case JapanLargeShop1.SPAWN_VILLAGER:
	...
	*/
	static
	{
		...
		//structure.addBlockArray(JapanBelfry.blockArrayNPCHut);
		...
		//structure.addBlockArray(JapanBelfry.blockArrayNPCBlackSmith);
		//structure.setFacing(StructureGeneratorBase.NORTH);
		//structures.add(structure);

		//structure = new Structure("Viking Shop");
		//structure.addBlockArray(JapanBelfry.blockArrayShop);
		//structure.setFacing(StructureGeneratorBase.WEST);
		//structures.add(structure);

		//structure = new Structure("Redstone Dungeon");
		//structure.addBlockArray(JapanBelfry.blockArrayRedstone);
		//structure.setFacing(StructureGeneratorBase.EAST);
		//structures.add(structure);

		//structure = new Structure("Offset Test");
		//structure.addBlockArray(JapanBelfry.blockArraySpawnTest);
		/*
		structure.addBlockArray(JapanBelfry.blockArrayOffsetTest1);
		structure.addBlockArray(JapanBelfry.blockArrayOffsetTest2);
		structure.addBlockArray(JapanBelfry.blockArrayOffsetTest2);
		structure.addBlockArray(JapanBelfry.blockArrayOffsetTest2);
		structure.addBlockArray(JapanBelfry.blockArrayOffsetTest1);
		*/
