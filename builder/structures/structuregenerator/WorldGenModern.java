...
public class WorldGenModern extends StructureGeneratorBase
{
	...
	public WorldGenModern(Entity entity, int[][][][] blocks)
	{
		super(entity, blocks);
	}

	public WorldGenModern(Entity entity, int[][][][] blocks, int structureFacing) 
	{
		super(entity, blocks, structureFacing);
	}

	public WorldGenModern(Entity entity, int[][][][] blocks, int structureFacing, int offX, int offY, int offZ) 
	{
		super(entity, blocks, structureFacing, offX, offY, offZ);
	}

	public WorldGenModern() 
	{
		super();
	}
	...
	*/
	...
	public void onCustomBlockAdded(World world, int x, int y, int z, int fakeID, int customData1, int customData2)
	{
		...
		switch(fakeID) 
		{
		case ModernStation1.CUSTOM_SIGNWALL: // no 'break' so it goes into the next case
		...
		case ModernCube.PAINTING:
			...
			String custom = (customData1 == 1 ? "Alban" : "Alban");
