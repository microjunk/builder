...
public class ModInventory extends InventoryMerchant implements IInventory
{
    ...
    public ModInventory(EntityPlayer par1EntityPlayer, IMerchant par2IMerchant, int par3)
    {
